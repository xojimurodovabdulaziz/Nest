...
const ProductColumns = () => {
  ...
  const columns = [
    { title: "Top Selling", items: byDiscount.slice(0, 3) },
    { title: "Trending Products", items: byReviews.slice(0, 3) },
    { title: "Recently added", items: byNewest.slice(0, 3) },
    { title: "Top Rated", items: byRating.slice(0, 3) },
  ];
